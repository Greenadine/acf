...
public class JDAMessageCommandListener extends ListenerAdapter {
    private final JDAMessageCommandManager manager;

    public JDAMessageCommandListener(JDAMessageCommandManager manager) {
